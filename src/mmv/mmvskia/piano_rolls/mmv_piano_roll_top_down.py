...
class MMVSkiaPianoRollTopDown:
    ...
    def generate_piano(self, min_note, max_note):
        ...
        self.piano_height = (4/19) * self.mmvskia_main.context.height
        ...
        for index, key_index in enumerate(self.piano_keys.keys()):
            ...
            if key.is_white:
                ...
                this_note_width = (3/6) * self.tone_width
    ...
    def draw_note(self, velocity, start, end, channel, note, name):
        ...
        note_paint = skia.Paint(
            ...
            #     colors=[skia.Color4f(0, 1, 1, 1), skia.Color4f(0, 1, 0, 1)]),
        ...
        # Rectangle border of the note
        rect = skia.Rect(*coords)
        rect = skia.RRect(rect, 9.0, 9.0)
        
        # Draw the note and border
        self.mmvskia_main.skia.canvas.drawRRect(rect, note_paint)
        self.mmvskia_main.skia.canvas.drawRRect(rect, note_border_paint)
...
class PianoKey:
    ...
    def configure_color(self):
        ...
        # self.marker_color = skia.ColorBLUE
    ...
    def draw(self, notes_playing, channels_playing=None):
        ...
        # Rectangle border of the note
        rect = skia.Rect(*coords)
        rect = skia.RRect(rect, 5.0, 5.0)
        
        # Draw the note and border
        self.mmvskia_main.skia.canvas.drawRRect(rect, key_paint)
        self.mmvskia_main.skia.canvas.drawRRect(rect, key_border)
