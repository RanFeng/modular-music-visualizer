...
if MODE == "music":
    ...
    INPUT_AUDIO = THIS_FILE_DIR + "/assets/free_assets/star.ogg"
...
# Piano Roll general configuration
    ...
    #   manual: You configure the final audio of the video
    ...
    PIANO_ROLL_SECONDS_OF_MIDI_CONTENT_ON_SCREEN = 2
...
if MODE == "piano_roll":
    ...
    PARTICLES = True  # Particles don't go along pretty well with the piano roll (yet?)
    VIGNETTING = True  # I like vignetting on the piano roll but it hurts a bit the visibility
else:
